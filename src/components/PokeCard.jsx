...
const PokeCard = ({ data }) => {
  ...
  return (
    <div className={`${gradientStyle} rounded-xl flex flex-col justify-center items-center w-full smmd:w-2/12 sm:w-1/3 md:w-1/4 m-4 py-2 hover:scale-105 hover:shadow-xl hover:shadow-blue-400 hover:drop-shadow-lg duration-200`}>
